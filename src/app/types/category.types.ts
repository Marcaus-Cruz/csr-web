...
export const BASE_CATEGORIES = Object.freeze([
  {
    ...
    text: "CHICKEN",
    ratings: [
      { category: "chicken", id: "chicken-crunch", text: "Crunch", value: 5 },
      {
        category: "chicken",
  ...
  },
  {
    ...
    ratings: [
      ...
      { category: "sauce", id: "sauce-amount", text: "Amount", value: 5 },
      { category: "sauce", id: "sauce-taste", text: "Taste", value: 5 },
    ],
  },
  {
    id: "bun",
    text: "BUN",
    ratings: [
      { category: "bun", id: "bun-texture", text: "Texture", value: 5 },
      { category: "bun", id: "bun-taste", text: "Taste", value: 5 },
    ],
  },
]) as CategoryType[];
